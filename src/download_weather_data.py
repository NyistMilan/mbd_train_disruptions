# Code provided by KNMI Open Data Platform team
...
async def main():
    api_key = "eyJvcmciOiI1ZTU1NGUxOTI3NGE5NjAwMDEyYTNlYjEiLCJpZCI6IjliMDQ3ZGY4OWI5YTQxMTBhM2ZmMGEzZjRjMTBkNzU5IiwiaCI6Im11cm11cjEyOCJ9"
    ...
    while True:
        params = {
            ...
            "orderBy": "filename",
            "sorting": "asc",
            "begin": f"hourly-observations-validated-20190101",
            "end": f"hourly-observations-validated-20260101",
        }
        if next_page_token:
